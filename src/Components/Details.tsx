      ...
      <header className="header max-w-full max-h-full">
        ...
        <div className=" h-15 pt-70 items-center pl-7">
          ...
          <div className="text-white text-sm mt-30 w-300 ml-20 flex justify-between ">
            <div className="text-2xl ml-5 ">
              ...
              <h1 className="flex text-xl pt-1  ">
                <span>
              ...
              <p className="text-sm pt-2">
                {" "}
                Years after retiring from their formidable ninja lives, <br />
                a dysfunctional family must return to shadowy missions
                <br /> to counteract a string of looming threats.
              </p>
            </div>
        ...
        <article>
          <div className="  flex items-center justify-center gap-3 flex-col mt-150">
            ...
            <div className="bg-[#1b1b1b] w-2xl h-25 rounded-lg question items-center flex justify-center">
              1{" "}
            </div>
            <div className="bg-[#1b1b1b] w-2xl h-25 rounded-lg question items-center flex justify-center">
              {" "}
          ...
          <div className="w-full h-full mt-50 ">
            ...
            <div className="mt-40 pl-20">
              <h1 className="text-xl ">
                About{" "}
                <span className="text-2xl font-bold">House of Ninjas</span>
              </h1>
              <div className="mt-3">
                <p>
                  <span className="font-bold text-[#1b1b1b] pr-3">
                    Director:
                  </span>{" "}
                  Dave Boyle
                </p>
                <p>
                  <span className="font-bold text-[#1b1b1b] pr-3">Cast:</span>
                  Kento Kaku, Yosuke Eguchi, Tae Kimura, Kengo Kora, Aju Makita,
                  Nobuko Miyamoto,
                  <br />
                  Tomorowo Taguchi, Riho Yoshioka, Tokio Emoto, Kyusaku Shimada,
                  Pierre Taki, <br />
                  Mariko Tsutsui, Tenta Banka, Takayuki Yamada
                </p>
                <p>
                  <span className="font-bold text-[#1b1b1b] pr-3">Genres:</span>{" "}
                ...
                <p>
                  ...
                  :TV-MAsmoking, violenceFor Mature Audiences.
                </p>
              </div>
            </div>
          </div>
